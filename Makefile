...
run-api: ## run api in development mode
	@echo 'Run api'
	@yarn run-api
run-emp: ## run nms (water network) client in development mode
	@echo 'Run employer frontend'
	@yarn run-emp
run-jsk: ## run ctm-web (water customer) in development mode
	@echo 'Run job seeker frontend'
	@yarn run-jsk
run-cms: ## run ctm-client (water customer) in development mode
