...
export default {
  ...
  statistic: {
    ...
    clientGroupedByType: 'Phân loại KH theo kiểu',
    clientGroupedByGeo: 'Phân loại KH theo địa lý',
    clientGroupedByWaterUsage: 'Xếp loại KH theo lượng nước sử dụng',
    topDebtOverdueClient: 'Top 7 Khách hàng nợ quá hạn',
    incomeGroupedByClientType: 'Phân loại Doanh thu theo kiểu KH',
    incomeGroupedByGeo: 'Phân loại Doanh thu theo địa lý',
  },
  // <Permission>
