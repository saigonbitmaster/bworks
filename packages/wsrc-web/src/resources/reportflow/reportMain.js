...
import { CustomPage, showDialog } from 'ra-loopback3';
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={12}>
            ...
            <FilterReportWaterSource
              formName={'wsrc-filter-report-flow-detail'}
...
const enhance = compose(connect(null, { showDialog }), withTheme, withStyles(styles));
