...
import { DetailIcon, LineChartIcon } from '../../styles/Icons';
        ...
        <Grid container>
          <AppBar position="static" color="default">
            <Tabs
              ...
              textColor="primary"
            >
              <Tab label={translate('resources.reportflows.tab1')} icon={<DetailIcon />} />
              <Tab label={translate('resources.reportflows.tab2')} icon={<LineChartIcon />} />
            </Tabs>
          </AppBar>
          {value === 0 && (
...
function mapStateToProps(state) {
  return {
    formname: 'save-tab-form-flow',
    tabIndex: getFormValues('save-tab-form-flow')(state),
  };
}
