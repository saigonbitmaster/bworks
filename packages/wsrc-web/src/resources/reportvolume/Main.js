...
import { DetailIcon, BarChartIcon } from '../../styles/Icons';
        ...
        <Grid container>
          <AppBar position="static" color="default">
            <Tabs
              ...
              textColor="primary"
            >
              <Tab label={translate('resources.reportvolumes.tab1')} icon={<DetailIcon />} />
              <Tab label={translate('resources.reportvolumes.tab2')} icon={<BarChartIcon />} />
            </Tabs>
          </AppBar>
          {value === 0 && (
...
function mapStateToProps(state) {
  return {
    formname: 'save-tab-form-statistic-volume',
    tabIndex: getFormValues('save-tab-form-statistic-volume')(state),
  };
}
