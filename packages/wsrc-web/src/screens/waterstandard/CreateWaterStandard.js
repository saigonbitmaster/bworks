...
class CreateWaterStandard extends Component {
  render() {
    const { props } = this;
    return (
      <Create {...props} resource="waterstandards">
...
CreateWaterStandard.detaultProps = {
  hasList: true,
  hasShow: true,
  hasCreate: false,
  hasEdit: false,
...
export default enhance(CreateWaterStandard);
