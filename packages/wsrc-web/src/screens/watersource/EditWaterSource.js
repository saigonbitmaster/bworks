...
class EditWaterSource extends Component {
  render() {
    const { props } = this;
    return (
      <Edit {...props} resource="watersources">
...
EditWaterSource.propTypes = {
  translate: PropTypes.func,
  hasList: PropTypes.bool,
  hasShow: PropTypes.bool,
  staticcontext: PropTypes.any,
};
EditWaterSource.detaultProps = {
  hasList: true,
  hasShow: true,
};

const enhance = compose(translate);
export default enhance(EditWaterSource);
