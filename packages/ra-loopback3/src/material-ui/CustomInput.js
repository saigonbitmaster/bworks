...
// Determine if an CustomInput is adorned on start.
...
export const styles = theme => {
  ...
  return {
    ...
    error: {},
    multiline: {
      padding: `${theme.spacing(1) - 2}px 0 ${theme.spacing(1) - 1}px`,
    },
    fullWidth: {
      width: '100%',
    },
...
CustomInput.propTypes = {
  ...
  value: PropTypes.oneOfType([
    ...
    PropTypes.number,
    PropTypes.object,
    PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.string, PropTypes.number, PropTypes.any])),
  ]),
  completeUI: PropTypes.bool,
};

CustomInput.muiName = 'CustomInput';
...
CustomInput.childContextTypes = {
  muiFormControl: PropTypes.object,
};

export default withStyles(styles, { name: 'MuiCustomInput' })(CustomInput);
