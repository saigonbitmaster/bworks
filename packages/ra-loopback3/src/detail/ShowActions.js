...
import { ListButton, EditButton, DeleteButton, RefreshButton } from 'ra-ui-materialui/lib/button';
 ...
 *     );
 */
const ShowActions = ({ basePath, className, data, hasEdit, hasList, resource, ...rest }) => (
  <CardActions className={className} {...sanitizeRestProps(rest)}>
    {hasEdit && <EditButton basePath={basePath} record={data} />}
    {hasList && <ListButton basePath={basePath} />}
    {hasEdit && <DeleteButton basePath={basePath} record={data} resource={resource} />}
    <RefreshButton />
  </CardActions>
);
