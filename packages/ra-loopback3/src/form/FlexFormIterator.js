...
import FlexFormIterativeItem from './FlexFormIterativeItem';
...
export class FlexFormIterator extends Component {
  constructor(props) {
    super(props);
    ...
    return fields ? (
      <ul className={classes.root}>
            ...
            <CSSTransition key={this.ids[index]} timeout={500} classNames="fade">
              <li className={classes.line}>
                ...
                <section className={classes.form}>
                  <FlexFormIterativeItem
                    elements={children}
                    forward={{ basePath, member, record: records ? records[index] : {}, resource }}
                  />
                </section>
                {!disableRemove && (
        ...
        {!disableAdd && (
          <li className={classes.line}>
            <span className={classes.action}>
              <Button className={classNames('button-add', `button-add-${source}`)} size="small" onClick={this.addField}>
...
FlexFormIterator.defaultProps = {
  disableAdd: false,
  disableRemove: false,
};

FlexFormIterator.propTypes = {
...
export default compose(translate, withStyles(styles))(FlexFormIterator);
