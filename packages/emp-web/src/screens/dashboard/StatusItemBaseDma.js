...
const StatusItemBaseDma = ({ currentStatus, classes, translate, theme, getDmaPadding }) => {
  ...
  // }
let currentStatus1 = [
  {waterSourceName: "Write Cardano ESROW smart contract", bidder: "Candidate name/wallet address: Peter", bidValue: "Bid at value (ADA): 120"},
  {waterSourceName: "Create Cardano Native and NFT token", bidder: "Candidate name/wallet address: addr_test1qrtzr4zdlc3kw7mv4mtg2v3f3q592za2psnpmvsm4x9t0t43ge73vmf7xvkn23tkyq30gd2jtlgztf3rw0mtvkjzv4vqcv0ejv", bidValue: "Bid value (ADA): 120"},
  {waterSourceName: "Build Cardano testNet node", bidder: "Candidate name/wallet address: Jenny", bidValue: "Bid at value (ADA): 120"},
  {waterSourceName: "Develop android/IOS walllet", bidder: "Candidate name/wallet address: Jackson", bidValue: "Bid at value (ADA): 120"}
]
  return (
