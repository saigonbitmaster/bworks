...
export {
  ...
  DeveloperBoard as ListClientMeterIcon,
  ...
  Business as CtmCompanyIcon,
  RecentActors as ReportQuantityClientIcon,
  FileCopy as ParentMenuReportIcon,
  MonetizationOn as ReportDebtClientIcon,
  MoneyOff as ReportRevenueLossClientIcon,
  AttachMoney as ReportIncomeIcon,
  MoneyOff as ReportRevenueLossWaterIcon,
  ...
  PhoneLinkSetup as RoleAppPermissionIcon,
  Visibility as ViewIcon,
  Opacity as WaterStationIcon,
  Print as PrintInvoiceByGeoIcon,
  Print as ExportPdfButtonIcon,
  ViewList as ListIcon,
  Edit as EditIcon,
  PlusOne as WriteWaterIcon,
  ...
  Description as EInvoiceDataIcon,
  Description as EInvoiceReportIcon,
  Search as TrackWriteWaterClientIcon,
  Games as ParentMenuUtilityIcon,
  Smartphone as EmployeeAppIcon,
  ViewModule as PackageConfigIcon,
  QuestionAnswer as AnswerIcon,
  Notifications as NotificationsIcon,
  Repeat as RepeatIcon,
  Layers as InspectMeterNumberIcon,
  Call as Conversation,
  CodeRounded as QrCodeIcon,
  Add as AddIcon,
