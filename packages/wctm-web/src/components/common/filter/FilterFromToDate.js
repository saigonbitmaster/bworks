...
import { FlexFormFilter, withDataProvider, translate, DateInput } from 'ra-loopback3';
...
class FilterFromToDate extends Component {
          ...
          >
            <Grid middle container>
              <DateInput
                ...
                style={{ marginLeft: '0px', width: '130px' }}
              />
              <DateInput
                date
                source={'toTime'}
...
export default enhance(FilterFromToDate);
