...
class EditPartner extends Component {
  render() {
    const { props } = this;
    return (
      <Edit {...props} resource="waterproviders">
        <FlexForm style={{ flexGrow: 1 }} spacing={2} redirect="list" submitOnEnter={false}>
          <Grid middle container spacing={2}>
            ...
            <Grid middle item xs={12} sm={6} />
            <Grid middle item xs={12} sm={6}>
              <ReferenceArrayInput fullWidth source="wardIds" reference="geowards">
                <SelectArrayInput optionText="name" />
              </ReferenceArrayInput>
            </Grid>
            <Grid middle item xs={12} sm={6} />
            <Grid middle item xs={12} sm={6}>
              <ArrayInput fullWidth source="bankAccountList">
                <SimpleFormIterator>
                  ...
                  <NumberInput label={accountNo} source="accountNo" validate={[required(), number()]} />
                </SimpleFormIterator>
              </ArrayInput>
            </Grid>
