...
class EditInstallationTeam extends Component {
  ...
  render() {
    const { props } = this;
    return (
      <Edit {...props} resource="installationteams">
...
EditInstallationTeam.propTypes = {
...
EditInstallationTeam.detaultProps = {
  hasList: true,
  hasShow: true,
};
...
export default enhance(EditInstallationTeam);
