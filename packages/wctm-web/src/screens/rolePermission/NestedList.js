...
class NestedList2 extends Component {
  ...
  displayPermissionProfile = async role => {
    ...
    this.props
      .dataProvider(CUSTOM, 'AppUsers', {
        ...
        fullUrl: true,
        body: { role, project: screens.projectKey },
      })
      .then(({ data: { urls = [], menu = {} } }) => {
  ...
  componentDidMount() {
    this.props.dataProvider(CUSTOM, 'PackageConfigs', { fullUrl: true, subUrl: screens.projectKey }).then(result => {
