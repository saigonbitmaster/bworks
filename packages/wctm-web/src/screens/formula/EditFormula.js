...
import { FlexForm, Edit, TextInput, required, translate, NumberInput, SelectInput, minValue } from 'ra-loopback3';
...
EditFormula.detaultProps = {
  hasList: true,
  hasShow: true,
  hasCreate: false,
  hasEdit: false,
};
export default compose(translate)(EditFormula);
