...
class ReportInvoiceByGeo extends Component {
  ...
  save = record => {
    ...
    this.props
      .dataProvider(CUSTOM, 'clientmeternumbers', {
        stream: 'file',
        method: 'get',
        subUrl: `exportExcelInvoiceSummaryGroupByGeo`,
  ...
  render() {
    ...
    return (
      <Create
        ...
        actions={null}
        hasList
        title={'generic.pages.reportInvoiceSummaryGroupByGeo'}
      >
        <FlexForm
...
export default enhance(ReportInvoiceByGeo);
