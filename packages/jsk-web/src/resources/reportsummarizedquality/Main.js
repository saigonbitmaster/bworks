...
import { DetailIcon, BubbleChartIcon } from '../../styles/Icons';
        ...
        <Grid container>
          <AppBar position="static" color="default">
            <Tabs
              ...
              textColor="primary"
            >
              <Tab label={translate('resources.reportsummarizedqualities.tab1')} icon={<DetailIcon />} />
              <Tab label={translate('resources.reportsummarizedqualities.tab2')} icon={<BubbleChartIcon />} />
            </Tabs>
          </AppBar>
          {value === 0 && (
...
function mapStateToProps(state) {
  return {
    formname: 'save-tab-form-statistic-quality',
    tabIndex: getFormValues('save-tab-form-statistic-quality')(state),
  };
}
