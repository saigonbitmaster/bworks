...
import { Button, BulkDeleteAction, translate } from 'ra-loopback3';
...
class CustomBulkAction extends Component {
  state = {
    isOpen: false,
    activeAction: null,
  };
...
CustomBulkAction.defaultProps = {
  children: <BulkDeleteAction />,
  label: 'ra.action.bulk_actions',
  selectedIds: [],
};

const EnhancedButton = compose(withStyles(styles), translate)(CustomBulkAction);
