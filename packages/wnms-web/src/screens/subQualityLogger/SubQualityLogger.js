...
class SubQualityLogger extends React.Component {
  state = {
...
function mapStateToProps(state) {
  return {
    formname: 'save-tab-sub-quality',
    tabIndex: getFormValues('save-tab-sub-quality')(state),
  };
}
const enhance = compose(translate, withStyles(styles), connect(mapStateToProps, { change }));
export default enhance(SubQualityLogger);
