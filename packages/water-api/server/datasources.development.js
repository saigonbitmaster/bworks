...
S3_BUCKET: "prod-thanhhoa-Bworks-online"
S3_KEY: "AKIAZMJCMC5HJ4CKGRE4"
S3_SECRET: "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"
 */
...
const mongoConfig = name => ({
  ...
  //url: `mongodb://${MONGO_HOST}:27017/${name}?serverSelectionTimeoutMS=500000&connectTimeoutMS=1000000&authSource=admin&authMechanism=SCRAM-SHA-256`,
  connector: 'mongodb',
...
console.log('nmsMain', dts.nmsMain.url);
module.exports = dts;
