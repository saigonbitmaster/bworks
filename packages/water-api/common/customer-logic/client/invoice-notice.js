...
module.exports = Client => {
  Client.invoiceNotice = async (id, width = 576, mode = 'raw', res) => {
    ...
    let template = {};
    template = await models.CtmTemplate.getTemplateContent('ClientInvoiceNotice');
    if (process.env.NODE_ENV === 'development') {
      template.content = readFileSync(`${process.cwd()}/../../tmp/invoice-notice.html`, 'utf8');
    }
  ...
  Client.remoteMethod('invoiceNotice', {
    accepts: [
