              ...
              <td bgcolor="#ffffff" style="padding: 10px 10px 40px 30px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    ...
                    >
                      Xin chào Quý khách với mã định danh <b style="font-size: 20px;">${code}</b>. Xin hãy nhấp vào nút dưới để tiến hành
                      tạo mật khẩu mới.
                    </td>
                  </tr>
                  <tr>
              ...
              <td bgcolor="#edeff0" style="padding: 30px 30px 30px 30px;">
                ...
                >
                  <tr>
                    ...
                    >
                      &reg; 2018 Công ty cổ phần Truyền thông &amp; Công nghệ
                      ngành Nước Bworks
                    </td>
                  </tr>
                </table>
